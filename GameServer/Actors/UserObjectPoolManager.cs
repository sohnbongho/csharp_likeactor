...
using Library.World;
using GameServer.Actors.User;
using System.Collections.Concurrent;
using System.Net.Sockets;

namespace GameServer.Actors;
...
public class UserObjectPoolManager
{
    ...
    public UserObjectPoolManager(LobbyThreadManager lobbyThreadManager, WorldThreadManager worldThreadManager, SqlWorkerManager sqlWorkerManager, CacheWorkerManager cacheWorkerManager)
    {
    ...
    public void Init()
    {
        _userSessionPool.Init(() => UserSession.Of(0, this, _sqlWorkerManager, _cacheWorkerManager));
    }
